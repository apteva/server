...
func TestFormatAgentChatEventIncludesReplyContract(t *testing.T) {
	...
	for _, want := range []string{
		"[chat]",
		"requires at least one visible channels_send reply",
		...
		"After any tool result used for this request",
		"before pacing or going idle",
		"CHAT COMPLETION REQUIREMENT",
		"Do not call pace first",
		"User message:",
		"What can you do?",
		"Dashboard context:",
		"- page: Overview",
